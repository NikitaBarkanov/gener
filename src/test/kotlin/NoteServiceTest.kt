...
class NoteServiceTest {
    ...
    private var commentForFirst1 : Comment = Comment(1, 1, 2, "")
    private var commentForFirst2 : Comment = Comment(1, 3, 2, "")
    private var commentForSecond1 : Comment = Comment(2, 2, 2, "")
    private var commentForSecond2 : Comment = Comment(2, 4, 2, "")
    ...
    fun getCommentsTest(){
        ...
        assertEquals(false, commentsGetArray.contentEquals(arrTest))
    }
    ...
    fun editCommentTest(){
        ...
        val textTest = realized.editComment(note1, commentForFirst2, "new text").text
